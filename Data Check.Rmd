...
events_full <- events_full  %>%
  mutate(groups = case_when(
    coverage_start_date < ibis_coverage_start_date ~ "Pre-IBIS",
    coverage_start_date >= ibis_coverage_start_date & coverage_start_date <= ibis_coverage_end_date ~ "IBIS",
    coverage_start_date > ibis_coverage_end_date ~ "Post-IBIS"
  ))
